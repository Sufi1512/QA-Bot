...
const sidebarItems = [
  ...
  { title: 'Call Dashboard', path: '/call-dashboard', icon: <Headphones className="h-5 w-5" /> },
];

const headerConfig = {
  "/": {
    title: "QA Monitoring Dashboard",
...
const ProfileModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <div className="mb-4">
      <label htmlFor="location" className="block text-sm font-medium text-gray-700">Company Location</label>
      <input
        type="text"
        id="location"
        value={location}
...
const AppLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {isAuthenticated() && (
        <aside
          className={`sidebar-container fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${
